...
import type { BlockEditorImageNode } from "./block-editor-image-node";
...
function $selectImageNode(imageNode: BlockEditorImageNode) {
...
function createNavigationHandler(direction: "forward" | "backward") {
  return (event: KeyboardEvent) => {
    ...
    if ($isBlockEditorImageNode(sibling)) {
...
export function BlockEditorImageNavigationPlugin() {
