...
} from "./block-editor-code-language-options";
...
function getControlPosition(editor: LexicalEditor, nodeKey: NodeKey) {
  ...
  const containerElement = rootElement?.closest(".block-editor") as HTMLElement | null;
...
export function BlockEditorCodeLanguagePlugin() {
