...
import { createTableNodeFromMarkdownLines } from "./block-editor-table-markdown";
import { isMarkdownTableDividerRow, isMarkdownTableRow } from "./block-editor-table-utils";
...
export function BlockEditorTableShortcutPlugin() {
